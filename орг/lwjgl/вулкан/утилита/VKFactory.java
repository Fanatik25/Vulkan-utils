...
public class VKFactory{
    ...
    public static VkDebugUtilsMessengerCreateInfoEXT VkDebugUtilsMessengerCreateInfoEXT(MemoryStack stack) {
    ...
    public static VkAccelerationStructureMemoryRequirementsInfoNV VkAccelerationStructureMemoryRequirementsInfoNV(MemoryStack stack) {
    ...
    public static VkSemaphoreTypeCreateInfoKHR VkSemaphoreTypeCreateInfo(MemoryStack stack) {
    ...
    public static VkWriteDescriptorSet.Buffer VkWriteDescriptorSet(MemoryStack stack, int count) {
    ...
    public static VkImageBlit.Buffer VkImageBlit(MemoryStack stack, int count) {
        return VkImageBlit.callocStack(count, stack);
    }

    public static VkSpecializationMapEntry.Buffer VkSpecializationMapEntry(MemoryStack stack, int count) {
        return VkSpecializationMapEntry.callocStack(count, stack);
    }

    public static VkSpecializationInfo VkSpecializationInfo(MemoryStack stack) {
        return VkSpecializationInfo.callocStack(stack);
    }

    public static VkQueryPoolCreateInfo VkQueryPoolCreateInfo(MemoryStack stack) {
    ...
    public static VkVertexInputBindingDescription.Buffer VkVertexInputBindingDescription(MemoryStack stack, int count) {
        return VkVertexInputBindingDescription.callocStack(count, stack);
    }

    public static VkVertexInputAttributeDescription.Buffer VkVertexInputAttributeDescription(MemoryStack stack, int count) {
        return VkVertexInputAttributeDescription.callocStack(count, stack);
    }

    public static VkPipelineVertexInputStateCreateInfo VkPipelineVertexInputStateCreateInfo(MemoryStack stack) {
    ...
    public static VkPipelineInputAssemblyStateCreateInfo VkPipelineInputAssemblyStateCreateInfo(MemoryStack stack) {
    ...
    public static VkPipelineColorBlendAttachmentState.Buffer VkPipelineColorBlendAttachmentState(MemoryStack stack, int count) {
        return VkPipelineColorBlendAttachmentState.callocStack(count, stack);
    }

    public static VkPipelineColorBlendStateCreateInfo VkPipelineColorBlendStateCreateInfo(MemoryStack stack) {
    ...
    public static VkPipelineViewportStateCreateInfo VkPipelineViewportStateCreateInfo(MemoryStack stack) {
        return VkPipelineViewportStateCreateInfo.callocStack(stack).sType(VK_STRUCTURE_TYPE_PIPELINE_VIEWPORT_STATE_CREATE_INFO);
    }

    public static VkPipelineDynamicStateCreateInfo VkPipelineDynamicStateCreateInfo(MemoryStack stack) {
    ...
    public static VkRect2D.Buffer VkRect2D(MemoryStack stack, int count) {
